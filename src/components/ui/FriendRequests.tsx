...
const FriendRequests: FC<FriendRequestsProps> = ({
    ...
    //     pusherClient.bind('incoming_friend_requests', friendReqiuestHandler)

    //     return () => {
    //         pusherClient.unsubscribe(toPusherKey(`user:${sessionId}:incoming_friend_request`)) 
    //         pusherClient.unbind('incoming_friend_requests', friendReqiuestHandler )
    //     }
    // },[])
